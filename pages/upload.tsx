                ...
                {videoAsset ? (
                  ...
                  <label className="cursor-pointer">
                    <div className="flex h-full flex-col items-center justify-center">
                      ...
                      <p className="mt-10 w-52 rounded bg-[#F51997] p-2 text-center font-medium text-white outline-none">
                        Select File
                      </p>
                    </div>
                    <input
        ...
        <div className="flex flex-col gap-3 pb-10">
          ...
          <div className="mt-10 flex gap-6">
            ...
            <button
              onClick={handlePost}
              type="button"
              className="text-md rounde w-28 bg-[#f51997] p-2 font-medium text-white outline-none lg:w-44"
            >
              Post
            </button>
          </div>
